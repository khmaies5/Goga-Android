...
import com.esprit.goga.bean.TranslationItem;
import com.esprit.android.util.MxxTextUtil;
import com.esprit.goga.manager.TranslateDbManager;
...
public class MxxTranslateManager {
	...
	public void showTranslationResultInDialog(String content ){
		...
		MxxTranslateManager.translate(content, TranslateUtil.FRENCH, dialog, new MxxTranslateManager.TranslateListener() {
...
//		MxxToastUtil.showToast(context, "translating...");
		MxxTranslateManager.translate(content, TranslateUtil.FRENCH, null, new MxxTranslateManager.TranslateListener() {
