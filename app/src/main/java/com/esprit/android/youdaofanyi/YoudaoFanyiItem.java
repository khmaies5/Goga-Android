...
//			}
	...
	/**
	 *Translate the josnArray returned in the translated result into legible text
	 * Such as "explains": [
	  "girl; girl, unmarried woman; female staff, actress; (man's) girlfriend",
	  "n. (Czech Republic) Jill"
	  ]
	 * @param jsonArray
	 * @return
	 */
