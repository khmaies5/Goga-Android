...
public class MxxPagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0x3Affffff;//0xff005092;// 0x66ffffff;//0xFF666666;//0xff379bffblue;//0xFF666666;
	...
	private int indicatorHeight = 6;//Underline height dp
	...
	public MxxPagerSlidingTabStrip(Context context) {
		this(context, null);
	}

	public MxxPagerSlidingTabStrip(Context context, AttributeSet attrs) {
...
//		a.recycle();
	...
	/**
	 * Whether or not the tabs are horizontally filled with screens
	 * @param shouldExpand
	 */
